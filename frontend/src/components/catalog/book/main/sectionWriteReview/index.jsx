...
export const SectionWriteReview = () => {
    return (
        <div className="flex flex-col gap-2 bg-neutral-100  mt-5 p-4 border border-neutral-200 rounded-xl w-[80%] mx-auto shadow">
            ...
            <div>
                <form>
                    <textarea className="textarea w-full bg-neutral-100 border border-gray-300" placeholder="Compartilhe sua opinião sobre esse livro..."></textarea>
